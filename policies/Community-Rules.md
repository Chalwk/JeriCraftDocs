...
| **Use Appropriate Discord Channels**             | Keep conversations relevant to channel purposes (e.g., no off-topic discussions in `#introductions`).                                                                                                                                                                                                                                                                                                             |
...
| **No Griefing in Protected Regions**             | Griefing (destroying or altering builds and resources) is not allowed in protected regions. Only members of the region have the ability to modify builds, and they cannot grief without the owner's permission (or an authorized individual's). If you come across a base outside of protected regions, it is considered open to raiding or destruction. Players are responsible for protecting their own builds. |
...
| Offense                                       | Description                                                                                         |
|-----------------------------------------------|-----------------------------------------------------------------------------------------------------|
| **Property Damage and Vandalism (Minecraft)** | Altering or destroying others' builds **in protected regions** without permission.                  |
