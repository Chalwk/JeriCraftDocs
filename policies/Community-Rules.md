...
| **No Griefing in Protected Regions**             | Griefing (destroying or altering builds and resources) is not possible in protected regions, as they are safeguarded from such actions. Only members of the region have the ability to modify builds, and they cannot grief without the owner's permission (or an authorized individual's). If you come across a base outside of protected regions, it is considered open to raiding or destruction. Players are responsible for protecting their own builds. |
